 ...
 *
 * The file is kept (not deleted) because ~76 pages still include it via
 * <script src="/site-back.js">. Emptying the body removes the green button
 * everywhere with zero per-page edits. Safe to drop the includes over time.
 */
/* intentionally empty */
